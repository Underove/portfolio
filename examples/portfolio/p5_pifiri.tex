...
\projpart{\faCog\hspace{1.3mm}시스템 및 하드웨어 구성}
\begin{cvitems}
...
\begin{substeps}
  \item PiCar-4WD 키트를 단순 if-else 조건문으로 제어하면 모터 출력 불균형으로 좌·우 헌팅(Hunting)과 경로 이탈이 발생.
...
\begin{substeps}
  ...
  \item '현재 로봇 위치는 어디야?' 같은 질문에 수집된 데이터 기반으로 답하는 실시간 Q\&A 제공.
\end{substeps}
