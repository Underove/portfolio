...
\projsummary{LLM(RAG·function calling) 기반 주식 정보 팩트체크 서비스 --- DART 공시 검색·교차검증부터 백엔드·웹·iOS 풀스택 개발과 클라우드 배포·운영까지}
...
\begin{substeps}
  ...
  \item \textbf{인덱싱} --- DART 공시 본문(800자·오버랩 150자)과 사용자 업로드 PDF를 청킹하고, Gemini 임베딩(gemini-embedding-001, 3072차원)으로 벡터화해 PostgreSQL(pgvector)에 저장.
