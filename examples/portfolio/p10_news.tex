...
\stephead{3}{군집-범주 매핑 및 Zero-shot 검토}
\begin{substeps}
  \item 각 군집이 어떤 범주인지 정의할 학습 라벨이 부재 --- 군집별 상위 기사를 직접 열람해 6개 범주에 수동 매핑.
  \item BART Zero-shot 분류를 검토했으나 6만 건 추론 비용 대비 실익이 없어 제외 (Macro F1 0.652).
\end{substeps}
